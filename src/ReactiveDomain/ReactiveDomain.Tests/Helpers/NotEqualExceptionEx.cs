...
namespace Xunit.Sdk
{
    ...
    public
#endif
    class NotEqualExceptionEx : AssertActualExpectedException
    {
        ...
        public NotEqualExceptionEx(object expected, object actual, string userMessage)
        ...
        public NotEqualExceptionEx(string expected, string actual, int expectedIndex, int actualIndex, string userMessage)
            : base(expected, actual, userMessage)
        {
