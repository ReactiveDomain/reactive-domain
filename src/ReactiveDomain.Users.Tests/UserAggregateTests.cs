    ...
    public sealed class UserAggregateTests
    {
        ...
        public void can_updateGivenName()
        {
            ...
            Assert.Collection(
                            ...
                            e =>
                            {
                                if (e is UserMsgs.GivenNameUpdated giveNameUpdated)
                                {
        ...
        public void can_updateSurName()
        {
            ...
            Assert.Collection(
                            ...
                            e =>
                            {
                                if (e is UserMsgs.SurnameUpdated surnameUpdated)
                                {
        ...
        public void can_updateFullName()
        {
            ...
            Assert.Collection(
                            ...
                            e =>
                            {
                                if (e is UserMsgs.FullNameUpdated fullNameUpdated)
                                {
        ...
        public void can_updateEmail()
        {
            ...
            Assert.Collection(
                            ...
                            e =>
                            {
                                if (e is UserMsgs.EmailUpdated emailUpdated)
                                {
        ...
        public void can_updateAuthDomain()
        {
            ...
            Assert.Collection(
                            ...
                            e =>
                            {
                                if (e is UserMsgs.AuthDomainUpdated authDomainUpdate)
                                {
        ...
        public void can_update_username()
        {
            ...
            Assert.Collection(
                            ...
                            e =>
                            {
                                if (e is UserMsgs.UserNameUpdated userNameUpdate)
                                {
