...
namespace ReactiveDomain.Testing {
    ...
    public class EmbeddedEventStoreFixture : IDisposable {
        ...
        public EmbeddedEventStoreFixture() {
            ...
            Connection = new ESConnection(EmbeddedEventStoreConnection.Create(_node));
        }
...
#elif NETCOREAPP2_0 || NETSTANDARD2_0 || NET452
    public class EmbeddedEventStoreFixture /*: IAsyncLifetime */  {
        ...
        public EmbeddedEventStoreFixture() {
            ...
            Connection = new MockEventStoreConnection("Test");
        }
